fetch(path + "stickman-basketball/post/mods-list.html").then(res => res.text()).then(html => {
...
fetch(path + "stickman-basketball/post/mod-packs-list.html").then(res => res.text()).then(html => {
