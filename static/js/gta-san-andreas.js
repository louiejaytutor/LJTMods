fetch(path + "gta-san-andreas/post/mods-list.html").then(res => res.text()).then(html => {
...
fetch(path + "gta-san-andreas/post/individual-mods-list.html").then(res => res.text()).then(html => {
